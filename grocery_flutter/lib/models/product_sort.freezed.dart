...
abstract class $ProductSortModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? lable, String? value});
}
...
class _$_ProductSortModel implements _ProductSortModel {
  _$_ProductSortModel({this.lable, this.value});
  ...
  @override
  String toString() {
    return 'ProductSortModel(lable: $lable, value: $value)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, lable, value);
...
abstract class _ProductSortModel implements ProductSortModel {
  factory _ProductSortModel({final String? lable, final String? value}) =
      _$_ProductSortModel;
